...
opisanie = ['Применяется для высокой активности', 'Применяется для высокой активности',
            'Для средней активности', 'Для поездок за хлебом']
products = ["Танк", "Вертолет", "Силовой тренжер", "Велосипед"]
